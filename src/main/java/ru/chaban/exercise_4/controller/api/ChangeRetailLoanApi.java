...
public interface ChangeRetailLoanApi {
    ...
    @PostMapping(value = "/p/c", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    CorporateSettlementInstanceCreateResponseDto changeArrangementPlanCondition(@RequestBody @Valid CorporateSettlementInstanceCreateRequestDto request);
